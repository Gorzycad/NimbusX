...
// import { notifyDirectMessage } from "../../helpers/notifyDirectMessage";
...
//   // Generate threadId (for simplicity, only allow 1 recipient at a time)
//   const threadId = useMemo(() => {
//     if (selectedStaff.length === 0) return null;
//     // Sort IDs to ensure threadId is consistent for sender + recipient
//     const ids = [user.uid, selectedStaff[0]].sort();
//     return ids.join("_");
//   }, [selectedStaff, user]);
...
//     // await addDoc(
//     //   collection(db, "companies", companyId, "users", receiverId, "notifications"),
//     //   {
//     //     type: "DIRECT_MESSAGE",
//     //     threadId,
//     //     senderId: user.uid,
...
//     //   senderId: user.uid,
//     //   senderName: staffNameMap[user.uid],
//     //   threadId,
//     //   messageText: text,
//     // });
...
//       <div className="chat-box" style={{ border: "1px solid #ccc", padding: 10, minHeight: 200, marginBottom: 10 }}>
//         {messages.map((m, i) => (
//           <div key={i}>
//             <strong>{staffNameMap[m.senderId] || m.senderName || "Unknown"}:</strong>
//             {m.text}
//           </div>
//         ))}

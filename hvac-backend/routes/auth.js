...
// import express from "express";
// //import { oauth2Client, SCOPES } from "../google/oauthClient.js";
// import oauthRoutes from "../google/oauthClient.js";
// import createOAuthClient from "../google/oauthClient.js";
// //import { CONFIG } from "../../electron/main.js";

// // Create client from Electron CONFIG
// const { oauth2Client, SCOPES } = createOAuthClient(CONFIG);
...
//     // ✅ Store tokens in session (NOT global)
//     req.session.googleTokens = tokens;
